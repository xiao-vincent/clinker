...
//	}
	...
	protected ResponseEntity<Object> handleDataIntegrityViolation(
		...
		if (ex.getCause() instanceof ConstraintViolationException) {
			ApiError database_error = new ApiError(HttpStatus.CONFLICT, "Database error", ex.getRootCause());
			return buildResponseEntity(database_error);
		}
	...
	protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(
			 ...
			 WebRequest request) {
		if (ex.getRootCause() instanceof InvalidEnumArgumentException) {
			return handleInvalidEnumArgument((InvalidEnumArgumentException) ex.getRootCause());
		}
		ApiError apiError = new ApiError(BAD_REQUEST);
	...
	protected ResponseEntity<Object> handleInvalidEnumArgument(
